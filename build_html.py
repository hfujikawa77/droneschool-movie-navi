...
<style>
  ...
  .titlebar{background:#1a3a5c;color:#fff;padding:8px 20px;font-size:14px;font-weight:600;letter-spacing:.02em}
  ...
  #q{flex:1;padding:12px 14px;font-size:16px;border:1px solid #ccc;border-radius:8px;box-sizing:border-box}
  #toggle{flex:none;padding:0 16px;font-size:14px;border:1px solid #1a3a5c;background:#1a3a5c;color:#fff;border-radius:8px;cursor:pointer;white-space:nowrap}
  #toggle:hover{background:#24527f}
...
<body>
<div class="topbar">
  <div class="titlebar">ドローンエンジニア養成塾 — 過去チャレンジ検索</div>
  <div class="controls"><div class="wrap">
    <div class="searchrow">
      <input id="q" placeholder="キーワード検索 (例: 非GPS コプター, ローバー, ラズパイ ...)">
      <button id="toggle" type="button" aria-expanded="false">絞り込み ▾</button>
    </div>
